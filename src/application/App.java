...
import controller.FlechettesMenuController;
import controller.JeuFlechettesController;
...
import modele.sauvegarde.GameState;
...
public class App extends Application
{
			...
			throws FileNotFoundException, IOException
	{
		...
		Pane rootMainMenu = mainMenuLoader
				.load(new FileInputStream("ressources/fxml/main_menu.fxml"));
			...
			throws FileNotFoundException, IOException
	{
		...
		Pane flechettesJeuRoot = flechettesJeuLoader.load(
				new FileInputStream("ressources/fxml/jeu_flechettes.fxml"));
			...
			throws FileNotFoundException, IOException
	{
		...
		Pane flechettesMenuRoot = flechettesMenuLoader.load(new FileInputStream(
				"ressources/fxml/flechettes_niveaux_menu.fxml"));
