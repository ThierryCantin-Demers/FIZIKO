package modele.jeuflechette.obstacles;
...
public class Lampe extends ImageView implements Obstacle
{
	 ...
	 */
	private final String IMAGE_DEFAUT_PATH = "ressources/images/lampe.png";
	...
	public Lampe()
	{
		...
		{
			System.out.println("Image de la cible non trouvée");
		}
