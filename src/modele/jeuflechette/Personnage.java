...
public class Personnage extends ImageView
{
	 ...
	 */
	private final String IMAGE_DEFAUT_PATH = "ressources/images/personnage.png";
	...
	public Personnage()
	{
		...
		try
		{
			this.setImage(new Image(new FileInputStream(IMAGE_DEFAUT_PATH)));

		}
		catch (FileNotFoundException e)
		{
			System.out.println("Image du personnage non trouvée");
		}
	...
	public void jouerAnimationLancement()
	{
		try
		{
			Image gif = new Image(new FileInputStream(
					"ressources/images/gif/lancementDard.gif"));
			this.setImage(gif);
		}
		catch (FileNotFoundException e)
		{
			System.out.println(
					"L'animation n'a pas pu être jouée dû à une erreur lors du chargement du gif!");
		}
	}
