...
import fiziko.modele.jeuflechette.GenerateurNiveauxFlechettes;
import fiziko.modele.jeuflechette.NiveauFlechettes;
import fiziko.modele.jeuflechette.Personnage;
                        ...
                        if (niveau.getDonneesNiveau().getAngleInit() == Math.PI
                            ...
                            niveau.getDonneesNiveau().setAngleInit(
                                    niveau.getDonneesNiveau().getAngleInit()
                                            - 0.00001);
                        } else if (niveau.getDonneesNiveau().getAngleInit() == 0) {
                            niveau.getDonneesNiveau().setAngleInit(
                                    niveau.getDonneesNiveau().getAngleInit()
                                            + 0.00001);
                        }
